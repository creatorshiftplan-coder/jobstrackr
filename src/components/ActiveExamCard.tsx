...
export function ActiveExamCard({ attempt }: ActiveExamCardProps) {
  ...
  return (
    <Link to="/tracker" className="block flex-shrink-0">
      <div className="p-3 sm:p-4 rounded-2xl bg-white/80 backdrop-blur-md shadow-lg border border-white/50 w-[150px] sm:w-[180px] h-[120px] sm:h-[140px] flex flex-col transition-all hover:bg-white/90 hover:scale-[1.02]">
